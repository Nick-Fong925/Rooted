...
export function WeeklyReflectionFilled() {
    ...
    <PhoneFrame>
      <div className="h-full flex flex-col pt-14">
        ...
        <div className="px-6 py-6 border-b border-[#EDE8DF]">
          <h1 className="text-xl text-[#1A1A1A] mb-1" style={{ fontFamily: 'Canela, serif', fontWeight: 400 }}>Week 3 Reflection</h1>
          <p className="text-sm text-[#8B6F47]" style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif' }}>Mar 3–9</p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 pb-24">
          ...
          <div className="flex gap-2 overflow-x-auto pb-4 mb-4">
            {tasks.map((task, index) => (
              <div
                key={index}
                className="px-4 py-2 rounded-full flex-shrink-0 bg-transparent border border-[#8B6F47] text-[#8B6F47]"
          ...
          {/* Reflection Questions - Plain Text */}
          <div className="space-y-6 mb-6">
            {/* Question 1 */}
            <div>
              <p className="text-sm text-[#8B6F47] mb-3" style={{ fontFamily: 'Canela, serif', fontWeight: 400 }}>
              ...
              <p className="text-sm leading-relaxed" style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#5C5248' }}>
                Reading before bed became a ritual I actually looked forward to. Having the book on my nightstand made it feel effortless.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed" style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#5C5248' }}>
                Wednesday and Thursday were really hard — back-to-back late nights at work left me with no energy. I skipped both days and felt guilty about it.
              </p>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                <p className="text-sm text-[#8B6F47] flex-1" style={{ fontFamily: 'Canela, serif', fontWeight: 400 }}>
              ...
              <p className="text-sm leading-relaxed" style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#5C5248' }}>
                I'd protect my evenings earlier in the week instead of letting work bleed in. Even 15 minutes would have been enough.
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-sm leading-relaxed" style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#5C5248' }}>
              Overall a decent week. The social media one is still the hardest — I keep picking up my phone on autopilot. Need a better cue to interrupt that.
            </p>
          </div>

          {/* Confirmation Pill - Non-Interactive */}
          <div className="bg-[#EDE8DF] rounded-full px-5 py-3 flex items-center justify-center gap-2">
            <Check size={16} color="#8B6F47" strokeWidth={2.5} />
            <p className="text-sm text-[#8B6F47]" style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif' }}>
              Reflection saved · Mar 9
            </p>
          </div>
        </div>
